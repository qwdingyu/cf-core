...
```ts
import { StripeProvider } from "@eforge/cf-core/features/payment";
...
```ts
import { Trc20Provider } from "@eforge/cf-core/features/payment";
...
import {
  ...
  stripeFactory,
  trc20Factory,
} from "@eforge/cf-core/features/payment";
...
```ts
import type { PaymentProvider, ProviderFactory } from "@eforge/cf-core/features/payment";
